...
{
	checkf(!CharacterCarriedWeaponMap.Contains(InWeaponTagToRegister), TEXT("A Weapon named %s has already been added as a carried weapon"), *InWeaponTagToRegister.ToString());
